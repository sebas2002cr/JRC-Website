...
export default function CheckoutConstitucionSociedad() {
  ...
  const planPrice = parseInt(process.env.NEXT_PUBLIC_PLAN_PRICE_PYME, 10); // Precio fijo para el servicio de Constitución de una Sociedad
    ...
    {isLoading && (
      ...
      <div className="m-auto flex w-full flex-col items-center justify-center bg-transparent p-4 md:flex-row">
        {/* La pagina no tiene un titulo visible propio: este h1 le da a
            ...
            alterar el diseno. */}
        <h1 className="sr-only">Inscripción de PYME en Costa Rica</h1>
        {paymentSuccess ? (
          // Pantalla de éxito
