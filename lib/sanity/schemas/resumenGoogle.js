...
export default {
  ...
  fields: [
    {
      name: "nombre",
      title: "Nombre del negocio en Google",
      type: "string",
      description:
        "Tal como figura en la ficha. Lo escribe la sincronización; es el encabezado del panel."
    },
    {
      name: "calificacion",
      title: "Calificación",
    ...
    {
      name: "enlaceResenas",
      title: "Enlace a las reseñas",
      type: "url",
      description:
        "A dónde lleva el botón 'Ver todas en Google'. Abre la lista de reseñas directamente, no la ficha del mapa."
    },
    {
      name: "enlacePerfil",
      title: "Enlace a la ficha en el mapa",
      type: "url",
      description:
        "La ubicación en Google Maps. Se usa como respaldo si falta el de reseñas."
    },
    {
      name: "actualizado",
