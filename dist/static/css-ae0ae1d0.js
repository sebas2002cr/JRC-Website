function y(i) {
  ...
  function s(e, o, r, t) {
    return (
      (e.context = new D(
        r,
        o.indentation() + (t === !1 ? 0 : o.indentUnit),
        e.context
      )),
      r
    );
  ...
  return (
    ...
    (a.pseudo = function (e, o, r) {
      return e == "meta"
        ? "pseudo"
        : e == "word"
          ? ((n = "variableName.constant"), r.context.type)
          : k(e, o, r);
    }),
    (a.documentTypes = function (e, o, r) {
      return e == "word" && b.hasOwnProperty(o.current())
      ...
      return e == "}"
        ...
        : e == "word"
          ? ((r.stateArg == "@font-face" &&
              !R.hasOwnProperty(o.current().toLowerCase())) ||
            (r.stateArg == "@counter-style" &&
              !ee.hasOwnProperty(o.current().toLowerCase()))
              ? (n = "error")
              : (n = "property"),
            "maybeprop")
          : "restricted_atBlock";
        ...
        return (
          ...
          t.prev &&
            ...
            (t.type == "block" ||
              ...
              t.type == "restricted_atBlock")
              ? ((t = t.prev), (q = t.indent))
              : ((d == ")" &&
                  (t.type == "parens" ||
                    t.type == "atBlock_parens")) ||
                  (d == "{" &&
                    (t.type == "at" || t.type == "atBlock"))) &&
